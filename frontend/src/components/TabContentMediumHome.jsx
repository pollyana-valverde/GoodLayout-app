    ...
    return (
        <div className="flex flex-wrap tabContentMediumHome justify-content-between gap-2">
            <Col className="flex flex-wrap justify-content-center tabContentInterMediumHome relative">
                ...
                <h5 className="exclusive absolute bottom-0 m-3 left-0">{tag1}</h5>
            </Col>
            <Col className="flex flex-wrap justify-content-center tabContentInterMediumHome relative">
                ...
                <h5 className="exclusive absolute bottom-0 m-3 left-0">{tag2}</h5>
            </Col>
            <Col className="flex flex-wrap justify-content-center tabContentInterMediumHome relative">
                ...
                <h5 className="exclusive absolute top-0 m-3 left-0">{tag3}</h5>
            </Col>
            <Col className="flex flex-wrap justify-content-center tabContentInterMediumHome relative">
                <img src={imgJardim4} alt="ImgExclusive" />
                <div className="absolute bottom-0 right-0 m-3">
                ...
                <h5 className="exclusive absolute top-0 m-3 left-0">{tag4}</h5>
            </Col>
            <Col className="flex flex-wrap justify-content-center tabContentInterMediumHome relative">
                <img src={imgJardim4} alt="ImgExclusive" />
                <div className="absolute bottom-0 right-0 m-3">
